...
# venue_gaa3[is.na(venue_gaa3)] = 0 #Lets na which are ties be 0
```

### 1st graph : Scatterplot
-Winner Score vs Venue, colour team
```{r}
team_graph <- ggplot(venue_gaa3) + 
...
#cannot figure out how to colour it in
```{r}
team_graph2 <- ggplot(county_gaa3, aes(x=Winner_Score, y=Venue),col= Winner)+
